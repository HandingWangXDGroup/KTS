classdef KTS< ALGORITHM
    ...
    % Evolutionary Multi-Objective Optimization," in IEEE Transactions on
    % Evolutionary Computation, doi: 10.1109/TEVC.2023.3300181.
    %------------------------------- Copyright --------------------------------
            ...
            while Algorithm.NotTerminated(A1)
                ...
                while w <= wmax1
                    if search_mode == 0
                        ...
                        OffspringDec = [OperatorGA(ParentCdec,{1,20,0,0});OperatorGA(ParentMdec,{0,0,1,20})];%;OperatorGA(CCA.dec,{1,20,1,20});OperatorGA(CDA.dec,{1,20,1,20})];
                    else
                        ...
                        %
                        Offspring1  = OperatorGA(CP2.dec(MatingPool1,:));
                        Offspring2  = OperatorGA(CDA.dec(MatingPool2,:));
